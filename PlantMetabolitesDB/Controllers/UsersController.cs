...
namespace PlantMetabolitesDB.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public UsersController(IUsersRepository usersRepository, ICommonRepository commonRepository, IOrganizationTypeRepository organizationTypeRepository)
        {
        ...
        {
            var model = _usersRepository.GetAllByUserType(3);
        ...
        public ActionResult AddUsers(UsersViewModel model)
        {
        ...
        [HttpGet]
        public ActionResult EditUsers(int UserKey)
        {
            ...
            return PartialView("_EditUsers", model);
        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult EditUsers(UsersViewModel model)
        {
            if (ModelState.IsValid)
            {
        ...
        [HttpGet]
        public ActionResult DeleteUser(int UserKey)
        {
        ...
        public JsonResult GenerateHashSaltPassword()
        {
            _usersRepository.UpdatePassword();
